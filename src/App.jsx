    ...
    return (
      <div>
        ...
        <div style={{display:"flex",gap:8,marginTop:8}}>
          <button onClick={()=>setShowMonthly(true)} style={{flex:1,background:"rgba(167,139,250,0.06)",border:`1px solid rgba(167,139,250,${T.isDark?"0.2":"0.3"})`,borderRadius:10,padding:"10px 0",color:"#a78bfa",cursor:"pointer",fontSize:BASE_FONT-2,fontWeight:700,boxShadow:T.shadow}}>
            🗓 マンスリータスク
          </button>
          <button onClick={()=>setShowGoogleCal(true)} style={{flex:1,background:"rgba(66,133,244,0.06)",border:`1px solid rgba(66,133,244,${T.isDark?"0.2":"0.3"})`,borderRadius:10,padding:"10px 0",color:"#4285f4",cursor:"pointer",fontSize:BASE_FONT-2,fontWeight:700,boxShadow:T.shadow}}>
            📅 Googleカレンダー
          </button>
        </div>
